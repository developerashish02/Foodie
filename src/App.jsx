  ...
  return (
    <header className="bg-white text-black px-4 py-6 h-24 border-2 ">
      <div className="container mx-auto flex justify-between items-center ">
        <img
          src="https://imgs.search.brave.com/9cRJkIsCWVqtXXZXlUIDAuZssnOI-Rj9JQOzwO8LFh0/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9pbWFn/ZWRlbGl2ZXJ5Lm5l/dC81TVlTYms0NU04/MHFBd2VjcmxLemRR/LzE5MTM2ZDRlLTNm/OTEtNDdmNC1mYmI4/LWUxOGU3ZDRjYjQw/MC9wdWJsaWM"
          alt="nav-logo"
          className="w-16"
        />
        <nav className="mr-4">
